...
// Router
require("./modules/routes/ext/is_logged_in_account.js").add_routes(app);		// middleware

//계정
require("./modules/routes/account/account").add_routes(app);

//부띠끄
require("./modules/routes/boutique/banner_list").add_routes(app);
require("./modules/routes/boutique/contents_view").add_routes(app);
require("./modules/routes/boutique/category_list").add_routes(app);
require("./modules/routes/boutique/brand_list").add_routes(app);
require("./modules/routes/boutique/product").add_routes(app);
require("./modules/routes/boutique/featured").add_routes(app);
require("./modules/routes/boutique/wish_list").add_routes(app);

//장바구니
require("./modules/routes/cart/cart.js").add_routes(app);

// 옷장 - 추후 확인
require("./modules/routes/dressroom/dress_room").add_routes(app);

// 라우팅 체크
require("./modules/routes/etc/app_check").add_routes(app);
