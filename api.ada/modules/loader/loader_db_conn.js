...
var Ada = require("../database/mysql_ada_connector.js")(checkConnect, runQS);       // ADA CONNECT
var Account = require("../database/mysql_ada_account_connector.js")(checkConnect, runQS);
