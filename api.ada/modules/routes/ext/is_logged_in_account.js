...
exports.add_routes = function (app) {
	...
	app.post("/ada/account/isloggedin/with", ROUTE_MIDDLEWARE.AUTH_APP_LOGIN_USER_ALLOW_APP, function(req, res) {
		...
		try {
            ...
            MYSQL_FIT_ADA_ACCOUNT_CONN.procIsLoginUserAccount(clientUID, accessToken, function (err, results) {
				if (err) {
