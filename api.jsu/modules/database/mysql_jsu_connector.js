...
//     host: global.CONFIG.MYSQL_JSU.HOST,
//     port: global.CONFIG.MYSQL_JSU.PORT,
//     user: global.CONFIG.MYSQL_JSU.USER,
//     password: global.CONFIG.MYSQL_JSU.PASSWORD,
//     database: global.CONFIG.MYSQL_JSU.DATABASE,
//     connectionLimit: 3
// });
//
// module.exports = function(checkConnect, runQS) {
//     function MYSQL_JSU_CONN() {
//         checkConnect(pool, "MYSQL_JSU_CONN.setInterval, pool.getConnection");
//     }
//
//     MYSQL_JSU_CONN.prototype.procWatchdogPing = function (callBack) {
...
//
//     // ȸ������ - �̸����ߺ� �߰�
//     MYSQL_JSU_CONN.prototype.procBookSearch = function (params, callBack) {
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
//             var queryStr = " CALL sp_test_book_search(  " + connection.escape(params.list_type) + " ) ";
//             runQS(connection, queryStr, callBack);
//         });
//     };
//
//     MYSQL_JSU_CONN.prototype.procBookSearchDetail = function (params, callBack) {
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
//             var queryStr = " CALL sp_test_book_search_detail(  " + Number(params.bookID) + " ) ";
//             runQS(connection, queryStr, callBack);
//         });
//     };
//
...
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
//             var queryStr = " CALL spMyBookMark(  " + Number(params.accountID) + " ) ";
//             runQS(connection, queryStr, callBack);
//         });
//     };
//
//     MYSQL_JSU_CONN.prototype.procMakeClub = function (params, callBack) {
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
...
//     };
//
//     MYSQL_JSU_CONN.prototype.procSearchClub = function (params, callBack) {
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
//             var queryStr = " CALL sp_test_search_club(  " + connection.escape(params.cName) + ", " +
//                 connection.escape(params.cRegion) + " ) ";
//             runQS(connection, queryStr, callBack);
//         });
//     };
//
// //    MYSQL_JSU_CONN.prototype.procSearchAllClub = function (params, callBack) {
// //        pool.getConnection(function (err, connection) {
// //            if (err) return callBack(err);
// //            var queryStr = " CALL sp_test_search_all_club( " + connection.escape(params.token) + " ) ";
// //            runQS(connection, queryStr, callBack);
// //        });
// //    };
//
...
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
//             var queryStr = " CALL sp_test_search_all_club()" ;
//             runQS(connection, queryStr, callBack);
//         });
//     };
//
//     MYSQL_JSU_CONN.prototype.procChangePublicClub = function (params, callBack) {
//         pool.getConnection(function (err, connection) {
//             if (err) return callBack(err);
