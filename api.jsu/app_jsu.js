...
//library
require("./modules/routes/library/book_search").add_routes(app);
require("./modules/routes/library/bookmarkEdit").add_routes(app);

//book
require("./modules/routes/library/book_rent").add_routes(app);

//my page
require("./modules/routes/myPage/myPage").add_routes(app);


//club
require("./modules/routes/club/club").add_routes(app);
require("./modules/routes/club/club_search").add_routes(app);


// require("./modules/routes/library/book_category").add_routes(app);
//test
