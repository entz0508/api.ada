...
{
	private m_head: HeadOrTailLinkedDictionaryPair<K, V>; // Head Identifier of the list.  holds no Keys or Value
	private m_tail: HeadOrTailLinkedDictionaryPair<K, V>; // Tail Identifier of the list.  holds no Keys or Value
