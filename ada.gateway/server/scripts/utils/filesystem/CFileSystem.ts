...
{
	public static async readFile(src: string, options: {throws?: boolean; fs?: object; reviver?: any; encoding?: string; flag?: string;} = {}): Promise<any>
	{
		return await fsExtra.readJSON(src, options);
	}
