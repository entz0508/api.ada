...
export class CDevelopEnvironment
{
	public static Path = class
	{
		public static JSONSavePath: string      = "/temp/upload/json";
		public static CDNSavePath: string       = "/temp/upload/cdn";

		public static DownloadURL: string       = "http://localhost:8081";
	};
