	...
	public connection(): redis.RedisClient
	{
		if (this.m_instance === null) {
			this.m_instance = this.createConnect(
				CConfig.Environment.RedisMaster.Host,
				CConfig.Environment.RedisMaster.Port,
				CConfig.Environment.RedisMaster.Database,
				CConfig.Environment.RedisMaster.Password
			);
		}
