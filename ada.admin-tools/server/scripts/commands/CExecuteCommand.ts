...
export class CExecuteCommand extends CSingleton
{
	 ...
	 * manage
	 ********************************************************************************************/
	public async executeCommand(uuid: number, dbShard: string, packetId: number, params: Object): Promise<ICommandResult>
	{
		...
		const response: ICommandResult = await command.execute(uuid, dbShard, params);
