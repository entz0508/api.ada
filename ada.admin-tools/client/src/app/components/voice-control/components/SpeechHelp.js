		...
		return (
			...
			<Modal show={this.props.showHelp}>
				<Modal.Body>
					...
					Click <span className="text-success">"Allow"</span> to access your microphone and activate Voice
					Command.
					You will notice a <span className="text-primary"><strong>BLUE</strong> Flash</span> on the
					microphone icon
					...
					className="fa fa-microphone fa-lg"/></span> if you <span
					className="text-danger">"Deny"</span> access or
					don't have
					any microphone installed.
					<br/>
					<br/>
					As a security precaution, your browser will disconnect the microphone every 60 to 120 seconds
					(sooner
					if not
