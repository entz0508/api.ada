											...
											<section>
												...
												<label className="input"> <i className="icon-append fa fa-envelope"/>
													...
													<b className="tooltip tooltip-top-right"><i
														className="fa fa-envelope txt-color-teal"/> Please
														enter email address for password reset</b></label>
											</section>
											<section>
										<span className="timeline-seperator text-center text-primary"> <span
											className="font-sm">OR</span>
                            </span></section>
											<section>
												...
												<label className="input"> <i className="icon-append fa fa-user"/>
													...
													<b className="tooltip tooltip-top-right"><i
														className="fa fa-user txt-color-teal"/> Enter your
														username</b> </label>
												<div className="note">
