		...
		return (
			...
			<div id="content">
				<div className="row">
					...
					<BigBreadcrumbs items={['Widgets']} icon="list-alt"
							...
							<p>The all new and revolutionary JarvisWidgets v2.0 (<strong>$35 value</strong>) is now only
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="action-buttons-popover">
										You can use 5 types of action buttons, toggle, edit, fullscreen, delete and
										custom button(s) which you can set for a custom action(s). You can even change
										the order of the action buttons. You can set a custom icon for every button. You
										can also add your own custom buttons, tabs, progress bars and more.
									</Popover>
								}>
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="jarvis-sortable-popover">
										The Jarvis Widgets are sortable, on tablet and some phones. Dont want sortable
										widgets on tables/phones, no problem you can remove this.
									</Popover>
								}>
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="jarvis-localStorage-popover">
										This plugin gives you the option to let you save a couple of settings for
										example the position, color and title of the widget.
									</Popover>
								}>
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="jarvis-Crosbrowser-popover">
										The Jarvis Widget works in every modern browser on windows, ios, osx, android,
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="jarvis-Callback-popover">
										The Jarvis Widget plugin has a couple of callback function wich you can use for
										several things, for example, use AJAX to store the data into a database.
									</Popover>
								}>
								...
								<OverlayTrigger placement="bottom" overlay={
									<Popover id="jarvis-More-popover">
										To give you more control you can set a lot of options per widget by using a
										dataset tag which will override the main plugin settings.
									</Popover>
								}>
							...
							<JarvisWidget>
								...
								<div>
									...
									<div className="widget-body">
										...
										<a href="#" className="btn btn-default btn-lg"> <strong>Big</strong>
											<i>Button</i> </a>
									</div>
									{/* end widget content */}
								</div>
									...
									<div className="widget-body">
										<div className="row">
											...
											<div className="col-md-6 col-lg-4">
												<img src="assets/img/demo/widget-colorpicker.png"
