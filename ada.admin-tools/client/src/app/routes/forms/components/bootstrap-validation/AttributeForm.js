...
export default class AttributeForm extends React.Component
{
	...
	render()
	{
		return (
			<BootstrapValidator>
				<form id="attributeForm" onSubmit={this.onSubmit} className="form-horizontal"
					...
					<fieldset>
						...
						<div className="alert alert-warning">
							...
							<a href="http://bootstrapvalidator.com/validators/"
							   target="_blank">http://bootstrapvalidator.com/validators/</a>
						</div>
