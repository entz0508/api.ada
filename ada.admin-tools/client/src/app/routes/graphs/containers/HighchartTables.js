...
export default () => (
	(
		<div id="content">
			<div className="row">
				<BigBreadcrumbs items={['HighchartTable']} icon="fa fa-fw fa-bar-chart-o"
				...
				<div className="row">
					...
					<div className="col-sm-12">
						...
						<div className="alert alert-info">
							...
							<ul>
								<li>The HighchartTable plugin takes data and attributes from a table and parses them to
									simply create an
									Hightcharts chart
								</li>
								...
								<li>See the full documentation <a href="http://highcharttable.org/#documentation"
								                                  target="_blank"><strong>here <i
									className="fa fa-link"/> </strong>
								</a></li>
							</ul>
						...
						<div className="col-sm-12 well">
							<div className="col-sm-6">
								<HighchartTable className="highchart table table-hover table-bordered"
								                data-graph-container=".. .. .highchart-container2"
						...
						<div className="col-sm-12 well">
							<div className="col-sm-6">
								<HighchartTable className="highchart table table-hover table-bordered"
								                data-graph-container=".. .. .highchart-container3"
								                data-graph-type="column">
