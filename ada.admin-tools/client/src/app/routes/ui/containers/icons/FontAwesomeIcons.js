...
export default class FontAwesomeIcons extends React.Component
{
	...
	render()
	{
		return (
			<div id="content">
				<div className="row">
					<BigBreadcrumbs items={['UI Elements', 'Icons', 'Font Awesome']} icon="fa fa-fw fa-flag"
					...
					<div className="row">
								...
								<div>
									...
									<div className="widget-body" id="all-icons-demo" ref='demoContainer'>
										...
										<div className="alert alert-info">
											<i className="fa fa-exclamation"/> Please note: As of the of Font Awesome
											version 4.0. All icons
											now require a base class of <code>
											fa</code> as well as individual icon classes. For example <code> fa
											fa-adjust</code>
											<br/>
											<div className="margin-top-5">View the full icon list by going to <a
												href="http://fortawesome.github.io/Font-Awesome/icons/"
												target="_blank">//fortawesome.github.io/Font-Awesome/icons/</a>
											</div>
										</div>

										<div className="alert alert-warning"><strong>NOTE</strong>: FontAwesome version
											4.2 is blurry on
											some resolutions, therefore we did not upgrade (the included FontAwesome
											version is 4.1).
											Hopefully this issue will be resolved in later versions of FontAwesome and
											will be safer to
											upgrade
										</div>
                     ...
                     <i className="fa fa-yelp"/> fa-yelp
										...
										<div className="row">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-automobile"/> fa-automobile <span
												className="text-muted">(alias)</span>
											</div>

											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-bank"/> fa-bank <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-cab"/> fa-cab <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-file-movie-o"/> fa-file-movie-o <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-file-photo-o"/> fa-file-photo-o <span
												className="text-muted">(alias)</span>
											</div>

											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-file-picture-o"/> fa-file-picture-o <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-file-sound-o"/> fa-file-sound-o <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-file-zip-o"/> fa-file-zip-o <span
												className="text-muted">(alias)</span>
											</div>

											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-ge"/> fa-ge <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-institution"/> fa-institution <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-life-bouy"/> fa-life-bouy <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-life-saver"/> fa-life-saver <span
												className="text-muted">(alias)</span>
											</div>

											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-mortar-board"/> fa-mortar-board <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-pied-piper-square"/> fa-pied-piper-square <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-ra"/> fa-ra <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-send"/> fa-send <span
												className="text-muted">(alias)</span>
											</div>

											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-send-o"/> fa-send-o <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-support"/> fa-support <span
												className="text-muted">(alias)</span>
											</div>
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-wechat"/> fa-wechat <span
												className="text-muted">(alias)</span>
											</div>
										...
										<div className="row">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-dashboard"/> fa-dashboard <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-edit"/> fa-edit <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-flash"/> fa-flash <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-gear"/> fa-gear <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-gears"/> fa-gears <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-legal"/> fa-legal <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-mail-forward"/> fa-mail-forward <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-mail-reply"/> fa-mail-reply <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-mobile-phone"/> fa-mobile-phone <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-sort-down"/> fa-sort-down <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-sort-up"/> fa-sort-up <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-star-half-empty"/> fa-star-half-empty <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-star-half-full"/> fa-star-half-full <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-toggle-down"/> fa-toggle-down <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-toggle-left"/> fa-toggle-left <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-toggle-right"/> fa-toggle-right <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-toggle-up"/> fa-toggle-up <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-unsorted"/> fa-unsorted <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-warning"/> fa-warning <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
										...
										<div className="row">
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-bitcoin"/> fa-bitcoin <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-cny"/> fa-cny <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-dollar"/> fa-dollar <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-euro"/> fa-euro <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-rmb"/> fa-rmb <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-rouble"/> fa-rouble <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-ruble"/> fa-ruble <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-rupee"/> fa-rupee <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-turkish-lira"/> fa-turkish-lira <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-won"/> fa-won <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-yen"/> fa-yen <span
												className="text-muted">(alias)</span>
											</div>
										</div>
										...
										<div className="row">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-chain"/> fa-chain <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-copy"/> fa-copy <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-cut"/> fa-cut <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-dedent"/> fa-dedent <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-eraser"/> fa-eraser
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-paste"/> fa-paste <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-rotate-left"/> fa-rotate-left <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-rotate-right"/> fa-rotate-right <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-save"/> fa-save <span
												className="text-muted">(alias)</span>
											</div>
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
											...
											<div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												<i className="fa fa-unlink"/> fa-unlink <span
												className="text-muted">(alias)</span>
											</div>
										</div>
