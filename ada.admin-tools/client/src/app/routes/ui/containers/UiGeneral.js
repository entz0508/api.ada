		...
		return (
			<div id="content">
                 ...
                 */}
                            ...
                            Click me<span className="nt">&lt;/a&gt;</span></code>
								...
								<div className="col-sm-12 col-md-12 col-lg-6">
									...
									<div className="well">
										...
										<ul className="demo-btns">
											<li>
												<a onClick={this._smartModEg1} className="btn btn-success"> Callback
													()</a>
											</li>
											<li>
										...
										<ul className="demo-btns">
											<li>
												<a onClick={this._smartModEg2} className="btn btn-primary"> With
													Input </a>
											</li>
											<li>
										...
										<ul className="demo-btns">
											<li>
												<a onClick={this._smartModEg5} className="btn btn-danger"> Login me
													in </a>
											</li>
										</ul>
							...
							<div className="row">
								...
								<div className="col-sm-12 col-md-12 col-lg-6">
									...
									<div className="well">
										<h3>Tooltips</h3>
										<p>
											Tip your users with a small tooltip. Nifty helpful information can be
											disaplayed using this very
											simple and yet effictive component. Display pure <strong>HTML
										...
										<ul className="demo-btns text-center">
											<li>
												<OverlayTrigger placement="top"
												                overlay={<Tooltip
													                id="h-1-b-one-b-em-really-em-big-tip-h-1-tooltip">
													                <h1>
														                <b>One</b> <em>Really</em> big tip!</h1>
												                </Tooltip>}><a href="#"
											...
											<li>
												<OverlayTrigger placement="top" overlay={<Tooltip
													...
													src="assets/img/avatars/sunny.png" alt="me"
													className="online"/></Tooltip>}><a href="#"
											...
											<li>
												<OverlayTrigger placement="bottom"
												                overlay={<Tooltip id="tooltip-bottom-tooltip">Tooltip
													                Bottom</Tooltip>}><a
													href="#" className="btn btn-default"><i
													className="fa fa-arrow-down"/> Tooltip
													Bottom</a></OverlayTrigger>
											</li>
											<li>
												<OverlayTrigger placement="right"
												                overlay={<Tooltip
													                id="i-class-fa-fa-check-text-success-i-tooltip-right-tooltip"><i
													                className="fa fa-check text-success"/> Tooltip Right</Tooltip>}><a
													href="#"
													className="btn btn-default"><i
								...
								<div className="col-sm-12 col-md-12 col-lg-6">
									...
									<div className="well">
										<h3>Popovers</h3>
										<p>
											Popovers are a cool way to express compressed information to the user,
											neatly and quickly. You can
											generate all kinds of content within the popover component.
											Including <strong>Forms</strong>,
											<strong>Tabs</strong>, <strong>Images</strong> and even <strong>Google
											map</strong>!
										</p>
										<br/>
										<ul className="demo-btns text-center">
											<li>
												<OverlayTrigger placement="top"
												                overlay={<Popover
													                id="popover-activated-on-hover-popover">Sed posuere
													                consectetur est at lobortis. Aenean eu leo quam.
													                Pellentesque ornare sem
													                lacinia quam venenatis vestibulum.</Popover>}><a
													href="#"
											...
											<li>
												<OverlayTrigger trigger="click" placement="top"
												                overlay={<Popover
													                id="h-4-tabs-inside-popover-h-4-popover">
													                <ul id="popup-tab"
													                    className="nav nav-tabs bordered">
														                <li className="active"><a href="#pop-1"
														                                          data-toggle="tab">Active
															                Tab </a>
														                </li>
														                <li><a href="#pop-2" data-toggle="tab">Tab 2</a>
														                </li>
													                </ul>
													                <div id="popup-tab-content"
													                     className="tab-content padding-10">
														                <div className="tab-pane fade in active"
														                     id="pop-1"><p>I have six locks on
															                my door all in a row. When I go out, I lock
															                every other one. I figure no
														                ...
														                <div className="tab-pane fade" id="pop-2">
															                <p>Food truck fixie locavore,
																                accusamus mcsweeney's marfa nulla
																                single-origin coffee squid. wes anderson
																                artisan four loko farm-to-table craft
																                beer twee.</p></div>
													                </div>
												                </Popover>}><a
													className="btn btn-default btn-lg"><strong>Active</strong>
													<i>Content</i></a></OverlayTrigger>
											</li>
											<li>
												<OverlayTrigger trigger="click" placement="top"
												                overlay={<Popover
													                id="i-class-fa-fa-fw-fa-pencil-i-form-inside-popover-popover">
													                <form action="/api/plug"
													...
													className="btn btn-default btn-lg"><strong>File</strong>
													<i>Access</i></a></OverlayTrigger>
											</li>
										</ul>
										...
										<ul className="demo-btns text-center">
											<li>
												<OverlayTrigger placement="left"
												                overlay={<Popover id="popover-left-popover">Sed posuere
													                consectetur est at
													                lobortis. Aenean eu leo quam. Pellentesque ornare
													                sem lacinia quam venenatis
													                vestibulum.</Popover>}><a href="#"
												                                              className="btn btn-default"><i
													className="fa fa-arrow-left"/> <strong>Popover</strong> <i>Left</i></a></OverlayTrigger>
											</li>
											<li>
												<OverlayTrigger placement="top"
												                overlay={<Popover id="popover-up-popover">Sed posuere
													                consectetur est at
													                lobortis. Aenean eu leo quam. Pellentesque ornare
													                sem lacinia quam venenatis
													                vestibulum.</Popover>}><a href="#"
											...
											<li>
												<OverlayTrigger placement="bottom"
												                overlay={<Popover id="popover-down-popover">Sed posuere
													                consectetur est at
													                lobortis. Aenean eu leo quam. Pellentesque ornare
													                sem lacinia quam venenatis
													                vestibulum.</Popover>}><a href="#"
											...
											<li>
												<OverlayTrigger placement="right"
												                overlay={<Popover id="popover-right-popover">Sed posuere
													                consectetur est at
													                lobortis. Aenean eu leo quam. Pellentesque ornare
													                sem lacinia quam venenatis
													                vestibulum.</Popover>}><a href="#"
												                                              className="btn btn-default"><i
													className="fa fa-arrow-right"/> <strong>Popover</strong>
													<i>Right</i></a></OverlayTrigger>
											</li>
										</ul>
					...
					<div className="row">
						<h2 className="row-seperator-header"><i className="fa fa-square-o"/> Containers, Media and
							Pagination</h2>
						<div className="col-sm-12 col-md-12 col-lg-6">
							...
							<div className="well">
								...
								<p>
									Learn more about other colors that you can use for .well by going to <a
								...
								<ul className="media-list">
									<li className="media">
										...
										<div className="media-body">
											...
											{/* Nested media object */}
											<div className="media">
												<a className="pull-left" href="#"> <img className="media-object"
												                                        alt="64x64"
